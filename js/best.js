	...
	$.fn.prettyPhoto = function(settings) {
			...
			$('div.pp_overlay').show().fadeTo(settings.animationSpeed,settings.opacity, function(){
				$pp_pic_holder.fadeIn(settings.animationSpeed,function(){
					...
					if(pp_type == 'image'){
						...
						$pp_pic_holder.find('#res')[0].innerHTML = pp_typeMarkup;
		...
		*/
		_showContent = function(){
			...
			$pp_pic_holder.animate({
				...
				$pp_pic_holder.find('#res').fadeIn(settings.animationSpeed);
				...
				if(pp_type != 'image') $pp_pic_holder.find('#res')[0].innerHTML = pp_typeMarkup;
		...
		*/
		function _hideContent(){
			$pp_pic_holder.find('#res object,#res embed').css('visibility','hidden');
			$pp_pic_holder.find('.pp_hoverContainer,.pp_details').fadeOut(settings.animationSpeed);
			$pp_pic_holder.find('#res').fadeOut(settings.animationSpeed,function(){
				$('.pp_loaderIcon').show();
			});
		...
		*/
		...
		function _buildOverlay(){
			...
			toInject += '<div class="pp_pic_holder"><div class="pp_top"><div class="pp_left"></div><div class="pp_middle"></div><div class="pp_right"></div></div><div class="pp_content"><a href="#" class="pp_expand" title="Expand the image">Expand</a><div class="pp_loaderIcon"></div><div class="pp_hoverContainer"><a class="pp_next" href="#"></a><a class="pp_previous" href="#"></a></div><div id="res"></div><div class="pp_details clearfix"><a class="pp_close" href="#"></a><p class="pp_description"></p><div class="pp_nav"><a href="#" class="pp_arrow_previous"></a><p class="currentTextHolder">0'+settings.counter_separator_label+'0</p><a href="#" class="pp_arrow_next"></a></div></div></div><div class="pp_bottom"><div class="pp_left"></div><div class="pp_middle"></div><div class="pp_right"></div></div></div>';
